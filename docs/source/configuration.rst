...
See `Routing Tasks <routing.html>`_ to read more about task routing, and the CELERY_ANNOTATIONS setting for more about annotations, or `Remote Control Guide <remotecontrol.html>`_ for more about remote control commands, and how to monitor what your workers are doing.
